...
interface CardModalDescriptionEditorProps {
	content: string;
	card: any;
	onSaveContent(content: string): void;
}

interface CardModalDescriptionEditorState {
	isEditing: boolean;
	newContent: string;
...
class CardModalDescriptionEditor extends Component<
	CardModalDescriptionEditorProps,
	CardModalDescriptionEditorState
	> {
	private input: React.RefObject<HTMLTextAreaElement>;
	private wrapper: React.RefObject<HTMLDivElement>;

	constructor(props: CardModalDescriptionEditorProps) {
		super(props);
