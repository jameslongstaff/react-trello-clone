...
//         if (err) { res.send(err); } else if (!article) { res.send(400); } else {
...
//       .exec((err, article) => {
//         if (err) { res.send(err); } else if (!article) { res.send(404); } else { res.send(article); }
//         next();
//       });
//   },
//   /**
...
//   },
// };
//# sourceMappingURL=board.ctrl.js.map